    ...
    <div className="mx-auto w-full max-w-[73rem] flex-col gap-3 p-5 md:flex-row md:p-10">
      <div className="flex flex-col">
        <div className="prose-dark">
          ...
          <h4 className="mt-5">การเก็บรวบรวมข้อมูลส่วนบุคคล</h4>
          ...
          <h4 className="mt-5">ประเภทข้อมูลส่วนบุคคลที่เก็บรวบรวม</h4>
          <p>
          ...
          <h4 className="mt-5">วิธีการเก็บรักษาข้อมูลส่วนบุคคล</h4>
          ...
          <h4 className="mt-5">การประมวลผลข้อมูลส่วนบุคคล</h4>
          ...
          <h4 className="mt-5">การเปิดเผยข้อมูลส่วนบุคคล</h4>
          <p>
          ...
          <h4 className="mt-5">ระยะเวลาจัดเก็บข้อมูลส่วนบุคคล</h4>
          <p>
          ...
          <h4 className="mt-5">สิทธิของเจ้าของข้อมูลส่วนบุคคล</h4>
          ...
          <h4 className="mt-5">การโฆษณาและการตลาด</h4>
          ...
          <h4 className="mt-5">เทคโนโลยีติดตามตัวบุคคล (Cookies)</h4>
          <p>
          ...
          <h4 className="mt-5">การรักษาความมั่งคงปลอดภัยของข้อมูลส่วนบุคคล</h4>
          <p>
          ...
          <h4 className="mt-5">การแจ้งเหตุละเมิดข้อมูลส่วนบุคคล</h4>
          <p>
          ...
          <h4 className="mt-5">การแก้ไขเปลี่ยนแปลงนโยบายความเป็นส่วนตัว</h4>
          <p>
          ...
          <h4 className="mt-5">นโยบายความเป็นส่วนตัวของเว็บไซต์อื่น</h4>
          <p>
          ...
          <h4 className="mt-5">รายละเอียดการติดต่อ</h4>
          <p>
